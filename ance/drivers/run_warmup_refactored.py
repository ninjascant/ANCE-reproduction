            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.logging_steps > 0 and global_step % args.logging_steps == 0:
                    ...
                    if args.evaluate_during_training and global_step % (
                            args.logging_steps_per_eval * args.logging_steps) == 0:
                        model.eval()
...
def load_stuff(model_type, args):
    ...
    config_obj = MSMarcoConfigDict[model_type]
    model_args = type('', (), {})()
    model_args.use_mean = config_obj.use_mean
    ...
    return config, tokenizer, model, config_obj
...
def run_warmup():
    ...
    config, tokenizer, model, config_obj = load_stuff(
    ...
    if args.do_train:
        ...
        def train_fn(line, i):
            return config_obj.process_fn(line, i, tokenizer, args)
